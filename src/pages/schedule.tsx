	  ...
	  <tbody>
		...
		<tr>
		  ...
		  <td>
			...
			<div className="presentation">
			  <div className="presentation-title">
				HarmonyMapper: Generating Emotionally Diverse Chord Progressions for Games Representation
			  </div>
			  <div className="presentation-speaker">
			...
			<div className="presentation">
			  ...
			  <div className="presentation-speaker">
				Jean-Baptiste Hervé, Oliver Withington, Marion Hervé, Laurissa Tokarchuk and Christoph Salge
			  </div>
			</div>
		  </td>
		</tr>
		...
		<tr>
		  ...
		  <td>
			...
			<div className="presentation">
			  ...
			  <div className="presentation-speaker">
				Shi Johnson-Bey, Micheal Mateas and Noah Wardip-Fruin
			  </div>
			</div>
		  </td>
		</tr>
        ...
        <tr>
          ...
          <td>
            ...
            <div className="presentation">
			  <div className="presentation-title">
				Knowledge Goal Recognition for Interactive Narratives Symbolic Reasoning
              </div>
              <div className="presentation-speaker">
...
Examining Early Professionals' Use of Generative AI in the Game Development Process
			  ...
			  <div className="presentation-speaker">
Josiah Boucher, Gillian Smith, Yunus Telliel
              </div>
            </div>
		  </td>
		</tr>
