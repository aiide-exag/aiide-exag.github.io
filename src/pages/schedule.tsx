                    ...
                    <tbody>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Enhancing MCTS with Convolutional
                                        Autoencoder and Linear Approximator in
                                        XCOM-Inspired Environments
                                    </div>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        HarmonyMapper: Generating Emotionally
                                        Diverse Chord Progressions for Games
                                        Representation
                                    </div>
                                    <div className="presentation-speaker">
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Exploring Minecraft Settlement
                                        Generators with Generative Shift
                                        Analysis
                                    </div>
                                    <div className="presentation-speaker">
                                        Jean-Baptiste Hervé, Oliver Withington,
                                        Marion Hervé, Laurissa Tokarchuk and
                                        Christoph Salge
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Towards Automated Video Game Commentary
                                        Using Generative AI
                                    </div>
                                    <div className="presentation-speaker">
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Thespian: Multi-Character Text
                                        Role-Playing Game Agents
                                    </div>
                                    <div className="presentation-speaker">
                                        Christopher Cui, Xiangyu Peng and Mark
                                        Riedl
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Dialogue Shaping: Empowering Agents
                                        through NPC Interaction
                                    </div>
                                    <div className="presentation-speaker">
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Toward using ChatGPT to generate
                                        theme-relevant simulated storyworlds
                                    </div>
                                    <div className="presentation-speaker">
                                        Shi Johnson-Bey, Micheal Mateas and Noah
                                        Wardip-Fruin
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Knowledge Goal Recognition for
                                        Interactive Narratives Symbolic
                                        Reasoning
                                    </div>
                                    <div className="presentation-speaker">
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Fast, Declarative, Character Simulation
                                        Using Bottom-Up Logic Programming
                                    </div>
                                    <div className="presentation-speaker">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Learning Constrained Graph Layout for
                                        Content Generation
                                    </div>
                                    <div className="presentation-speaker">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Little Learning Machines: Real-time deep
                                        reinforcement learning as a casual
                                        creativity game
                                    </div>
                                    <div className="presentation-speaker">
                                        Dante Camarena, Nick Counter, Daniil
                                        Markelov, Pietro Gagliano, Don
                                        Nguyen,Rhys Becker, Fiona Firby, Zina
                                        Rahman, Richard Rosenbaum, Liam A.
                                        Clarke and Maria Skibinski
                                    </div>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Visual Exploration of Tile Level
                                        Datasets
                                    </div>
                                    <div className="presentation-speaker">
                                        Seth Cooper, Faisal Abutarab, Emily
                                        Halina and Nathan Sturtevant
                                    </div>
                                </div>
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Examining Early Professionals' Use of
                                        Generative AI in the Game Development
                                        Process
                                    </div>
                                    <div className="presentation-speaker">
                                        Josiah Boucher, Gillian Smith, Yunus
                                        Telliel
                                    </div>
                                </div>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        Moirai: Enabling Complex Narrative
                                        Structure in Simulation-Driven Stories
                                    </div>
                                    <div className="presentation-speaker">
                                ...
                                <div className="presentation">
                                    <div className="presentation-title">
                                        An Executable Ontology for Social
                                        Simulation
                                    </div>
                                    <div className="presentation-speaker">
